...
public class NotificationServiceImpl implements NotificationService {
    ...
    @Override
    public NotificationResponse insertNotification(NotificationRequest notificationRequest) {
        ...
        NotificationEvent event = NotificationMapper.INSTANCE.toEvent(notificationEntity);
